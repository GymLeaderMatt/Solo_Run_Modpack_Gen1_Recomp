...
how I'd use it. The defaults *are* the ruleset. Everything below is a toggle in
**MOD OPTIONS** if you want something different. Here's a rundown.
...
| **NO SOUND WAITS** | ON | Removes the pauses where the game stands still waiting for a jingle or a cry to finish. Receiving an item, leveling up, learning a move, a Pokémon being sent out. The sound still plays, the game just stops waiting for it. |
...
I locked DIG behind Cascade. Not a big deal and doesn't change gameplay.
